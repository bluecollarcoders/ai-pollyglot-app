    ...
    try {
        const response = await client.responses.create({
            ...
            input: [
                {
                    role: "system",
                    content: "You are a world class polyglott, who has 30 years experience teaching and interpretting different languages. Return word for word translations in a sentence, in French, Spanish, and Japanese into english."
                },
                {
                    role: "user",
